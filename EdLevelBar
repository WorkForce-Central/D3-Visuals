var data = [
  {"EdLevel":"Less than High School Diploma","quantity":24},
  {"EdLevel":"High School Diploma or Equivalent","quantity":15},
  {"EdLevel":"Some College Classes","quantity":5},
  {"EdLevel":"Associate's Degreee","quantity":10},
  {"EdLevel":"Post- Secondary Certification","quantity":30},
  {"EdLevel":"Bachelor's Degree","quantity":21},
  {"EdLevel":"Master's Degree","quantity":13},
  {"EdLevel":"Doctoral Degree","quantity":9}]
...
xScale.domain(data.map(function(d) { return d.EdLevel; }));
...
var xAxis_g = svgContainer.append("g")
	...
	svgContainer.selectAll(".bar")
  		...
  		.append("rect")
  		.attr("class", "bar")
  		.attr("x", function(d) { return xScale(d.EdLevel); })
...
function resize() {
  ...
  // resize the chart
   ...
   svgContainer.selectAll("text")  		
	 // .attr("x", function(d) { return xScale(d.EdLevel); })
	 .attr("x", (function(d) { return xScale(d.EdLevel	) + xScale.rangeBand() / 2 ; }  ))
  ...
  // Controls the text labels at the top of each bar. Partially repeated in the resize() function below for responsiveness.
	svgContainer.selectAll(".text")  		
	  ...
	  .attr("y", function(d) { return yScale(d.quantity) + 1; })
	  .attr("dy", ".75em")
	  .text(function(d) { return d.quantity; });   	 function wrap(text, width) {
  text.each(function() {
